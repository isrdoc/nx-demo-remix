  ...
  return (
    <div className="about">
      <div className="about__intro">
        ...
        <p>
          Did you notice that things look a little different on this page? The CSS that we import in the route file and
          include in its <code>links</code> export is only included on this route and its children.
        </p>
        <p>
